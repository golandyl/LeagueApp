      ...
      {showRecoveryBanner && (
        <div className="flex items-center justify-between gap-3 rounded-xl border border-sky-700 bg-sky-900/50 px-4 py-3">
          <p className="text-sm font-semibold leading-snug text-sky-300">
            ⚡ Session recovered — review the score, then resume.
          </p>
          <button
  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center gap-8 bg-slate-900 px-5">
      <div className="flex w-full items-center justify-between gap-3">
        ...
        <span className="shrink-0 text-3xl font-black text-slate-500">VS</span>
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-slate-900 px-4 py-8 gap-6">
      ...
      {goals.length > 0 ? (
        ...
        <p className="text-center text-sm italic text-slate-600">No goals recorded</p>
      )}
    </div>
  )
}
...
function GoalLog({
  ...
  return (
    <div className="rounded-2xl bg-slate-800 p-4">
      <h3 className="mb-3 text-xs font-bold uppercase tracking-widest text-slate-500">Goals</h3>
